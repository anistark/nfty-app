...
const Index = () => {
  return (
    <div className="container mx-auto px-4 pt-24">
      ...
      {/* Why NFTy 50 Section */}
      <section className="mb-20 py-16 bg-secondary/10 rounded-3xl">
      ...
      <section className="mb-20">
        <h2 className="text-3xl font-bold mb-8">Top Performing NFTs</h2>
        <NFTTable nfts={topNFTs} />
      </section>

      {/* Liquidity Pools */}
      <section className="mb-20">
        <h2 className="text-3xl font-bold mb-8">Active Liquidity Pools</h2>
      ...
      {/* Call to Action */}
      <section className="mb-20 py-16 bg-primary/10 rounded-3xl text-center">
